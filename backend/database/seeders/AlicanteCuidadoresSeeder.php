        ...
        $cuidadores = [
            [
                'user' => [
                    ...
                    'latitude'           => 38.3452,
                    'longitude'          => -0.4810,
                    'servicios_ofrecidos'=> json_encode(['paseo', 'alojamiento', 'guarderia']),
                    'tamanos_aceptados'  => json_encode(['pequeño', 'mediano', 'grande']),
                    'especie_preferida'  => json_encode(['perro', 'gato']),
                ],
                'host' => [
                    'name'               => 'María García Sánchez',
            ...
            [
                'user' => [
                    ...
                    'latitude'           => 38.3978,
                    'longitude'          => -0.5153,
                    'servicios_ofrecidos'=> json_encode(['paseo', 'alojamiento', 'cuidado_a_domicilio']),
                    'tamanos_aceptados'  => json_encode(['mediano', 'grande']),
                    'especie_preferida'  => json_encode(['perro']),
                ],
                'host' => [
                    'name'               => 'Carlos Martínez López',
            ...
            [
                'user' => [
                    ...
                    'latitude'           => 38.4311,
                    'longitude'          => -0.4500,
                    'servicios_ofrecidos'=> json_encode(['guarderia', 'visitas_a_domicilio', 'cuidado_a_domicilio']),
                    'tamanos_aceptados'  => json_encode(['pequeño', 'mediano']),
                    'especie_preferida'  => json_encode(['perro', 'gato', 'otro']),
                ],
                'host' => [
                    'name'               => 'Ana Rodríguez Pérez',
            ...
            [
                'user' => [
                    ...
                    'latitude'           => 38.4375,
                    'longitude'          => -0.3947,
                    'servicios_ofrecidos'=> json_encode(['alojamiento', 'paseo', 'guarderia']),
                    'tamanos_aceptados'  => json_encode(['pequeño', 'mediano', 'grande']),
                    'especie_preferida'  => json_encode(['perro']),
                ],
                'host' => [
            ...
            [
                'user' => [
                    ...
                    'latitude'           => 38.4036,
                    'longitude'          => -0.4211,
                    'servicios_ofrecidos'=> json_encode(['visitas_a_domicilio', 'paseo', 'cuidado_a_domicilio']),
                    'tamanos_aceptados'  => json_encode(['pequeño', 'mediano']),
                    'especie_preferida'  => json_encode(['perro', 'gato']),
                ],
                'host' => [
        ...
        $empresas = [
            [
                'user' => [
                    ...
                    'latitude'           => 38.3550,
                    'longitude'          => -0.4800,
                    'servicios_ofrecidos'=> json_encode(['guarderia', 'visitas_a_domicilio']),
                    'tamanos_aceptados'  => json_encode(['pequeño', 'mediano', 'grande']),
                    'especie_preferida'  => json_encode(['perro', 'gato', 'otro']),
                ],
                'host' => [
            ...
            [
                'user' => [
                    ...
                    'latitude'           => 38.3700,
                    'longitude'          => -0.4950,
                    'servicios_ofrecidos'=> json_encode(['paseo', 'guarderia', 'cuidado_a_domicilio']),
                    'tamanos_aceptados'  => json_encode(['pequeño', 'mediano', 'grande']),
                    'especie_preferida'  => json_encode(['perro']),
                ],
                'host' => [
